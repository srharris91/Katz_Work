/**
 * \brief
 * Class Tri2dFCSPLamBcFarField holds the data and specifies the operations for
...
#ifndef included_Tri2dFCSPLamBcFarField
#define included_Tri2dFCSPLamBcFarField

#include "TRI2DFC_defs.h"
#include "Tri2dFCSPLamBc.h"


class Tri2dFCSPLamBcFarField: public Tri2dFCSPLamBc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Tri2dFCSPLamBcFarField class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPLam/Tri2dFCSPLamBcFarField.C Tri2dFCSPLamBcFarField
   */
  Tri2dFCSPLamBcFarField();

  /**
   * \brief
   * Destructor for the Tri2dFCSPLamBcFarField class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/Tri2dFCSPLamBcFarField.C
   */
