/**
 * \brief
 * Class Tri2dFCSPLamBcInviscidWall holds the data and specifies the operations for
...
#ifndef included_Tri2dFCSPLamBcInviscidWall
#define included_Tri2dFCSPLamBcInviscidWall

#include "TRI2DFC_defs.h"
#include "Tri2dFCSPLamBc.h"


class Tri2dFCSPLamBcInviscidWall: public Tri2dFCSPLamBc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Tri2dFCSPLamBcInviscidWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPLam/Tri2dFCSPLamBcInviscidWall.C Tri2dFCSPLamBcInviscidWall
   */
  Tri2dFCSPLamBcInviscidWall();

  /**
   * \brief
   * Destructor for the Tri2dFCSPLamBcInviscidWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/Tri2dFCSPLamBcInviscidWall.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/Tri2dFCSPLamBcInviscidWall.C surfaceForces
   */
   ...
   * 2014-3-7
   * \par Further Documentation:
   * \snippet src/System/SystemSPLam/Tri2dFCSPLamBcInviscidWall.C surfaceSolution
   */
