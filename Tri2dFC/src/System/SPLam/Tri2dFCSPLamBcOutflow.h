/**
 * \brief
 * Class Tri2dFCSPLamBcOutflow holds the data and specifies the operations for
...
#ifndef included_Tri2dFCSPLamBcOutflow
#define included_Tri2dFCSPLamBcOutflow

#include "TRI2DFC_defs.h"
#include "Tri2dFCSPLamBc.h"


class Tri2dFCSPLamBcOutflow: public Tri2dFCSPLamBc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Tri2dFCSPLamBcOutflow class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPLam/Tri2dFCSPLamBcOutflow.C Tri2dFCSPLamBcOutflow
   */
  Tri2dFCSPLamBcOutflow();

  /**
   * \brief
   * Destructor for the Tri2dFCSPLamBcOutflow class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/Tri2dFCSPLamBcOutflow.C
   */
