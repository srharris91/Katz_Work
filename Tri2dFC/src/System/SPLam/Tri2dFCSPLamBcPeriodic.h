/**
 * \brief
 * Class Tri2dFCSPLamBcPeriodic holds the data and specifies the operations for
...
#ifndef included_Tri2dFCSPLamBcPeriodic
#define included_Tri2dFCSPLamBcPeriodic

#include "TRI2DFC_defs.h"
#include "Tri2dFCSPLamBc.h"


class Tri2dFCSPLamBcPeriodic: public Tri2dFCSPLamBc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Tri2dFCSPLamBcPeriodic class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPLam/Tri2dFCSPLamBcPeriodic.C Tri2dFCSPLamBcPeriodic
   */
  Tri2dFCSPLamBcPeriodic();

  /**
   * \brief
   * Destructor for the Tri2dFCSPLamBcPeriodic class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/Tri2dFCSPLamBcPeriodic.C
   */
