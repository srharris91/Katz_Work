...
int* StrandMultiBlockMesh::d_nFaces = NULL;
int* StrandMultiBlockMesh::d_nNodes = NULL;
int* StrandMultiBlockMesh::d_nBedges = NULL;
int* StrandMultiBlockMesh::d_nPstr = NULL;
int* StrandMultiBlockMesh::d_nFringe = NULL;
int** StrandMultiBlockMesh::d_face = NULL;
int** StrandMultiBlockMesh::d_bEdge = NULL;
double** StrandMultiBlockMesh::d_xSrf = NULL;
double** StrandMultiBlockMesh::d_xStr = NULL;
double** StrandMultiBlockMesh::d_pV = NULL;
...
void StrandMultiBlockMesh::initialize()
{
  ...
  d_nFaces = new int[d_nStrandBlocks];
  d_nNodes = new int[d_nStrandBlocks];
  d_nBedges = new int[d_nStrandBlocks];
  d_nPstr = new int[d_nStrandBlocks];
  d_nFringe = new int[d_nStrandBlocks];
  d_face = new int*[d_nStrandBlocks];
  d_bEdge = new int*[d_nStrandBlocks];
  d_xSrf = new double*[d_nStrandBlocks];
  d_xStr = new double*[d_nStrandBlocks];
  d_pV = new double*[d_nStrandBlocks];
  ...
  for (int n=0; n<d_nStrandBlocks; n++)
    {
      ...
      d_nFaces[n] = nFaces[n];
      d_nNodes[n] = nNodes[n];
      d_nBedges[n] = nBedges[n];
      d_nPstr[n] = nPstr[n];
      d_nFringe[n] = nFringe[n];
    }
  ...
  for (int n=0; n<d_nStrandBlocks; n++)
    {
      ...
      d_face[n] = d_strandBlocks[n].getFace();
      d_bEdge[n] = d_strandBlocks[n].getBEdge();
      d_xSrf[n] = d_strandBlocks[n].getXSrf();
      d_xStr[n] = d_strandBlocks[n].getXStr();
      d_pV[n] = d_strandBlocks[n].getPV();
...
StrandMultiBlockMesh::~StrandMultiBlockMesh()
{
  ...
  if (d_nFaces) delete [] d_nFaces;
  if (d_nNodes) delete [] d_nNodes;
  if (d_nBedges) delete [] d_nBedges;
  if (d_nPstr) delete [] d_nPstr;
  if (d_nFringe) delete [] d_nFringe;
...
int* StrandMultiBlockMesh::getNFaces()
{
  return(d_nFaces);
}

int* StrandMultiBlockMesh::getNNodes()
{
  return(d_nNodes);
}

int* StrandMultiBlockMesh::getNBedges()
{
  return(d_nBedges);
}

int* StrandMultiBlockMesh::getNPstr()
{
  return(d_nPstr);
}

int* StrandMultiBlockMesh::getNFringe()
{
  return(d_nFringe);
}

int** StrandMultiBlockMesh::getFace()
{
  return(d_face);
}

int** StrandMultiBlockMesh::getBEdge()
{
  return(d_bEdge);
}

double** StrandMultiBlockMesh::getXSrf()
{
  return(d_xSrf);
}

double** StrandMultiBlockMesh::getXStr()
{
  return(d_xStr);
}

double** StrandMultiBlockMesh::getPV()
{
  return(d_pV);
}
