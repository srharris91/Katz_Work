/**
 * \brief
 * Class Strand2dFCSPLamBcViscousWall holds the data and specifies the
 * operations for
...
#ifndef included_Strand2dFCSPLamBcViscousWall
#define included_Strand2dFCSPLamBcViscousWall

#include "STRAND2DFC_defs.h"
#include "Strand2dFCSPLamBc.h"


class Strand2dFCSPLamBcViscousWall: public Strand2dFCSPLamBc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Strand2dFCSPLamBcViscousWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPLam/Strand2dFCSPLamBcViscousWall.C Strand2dFCSPLamBcViscousWall
   */
  Strand2dFCSPLamBcViscousWall();

  /**
   * \brief
   * Destructor for the Strand2dFCSPLamBcViscousWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/Strand2dFCSPLamBcViscousWall.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/Strand2dFCSPLamBcViscousWall.C surfaceForces
   */
