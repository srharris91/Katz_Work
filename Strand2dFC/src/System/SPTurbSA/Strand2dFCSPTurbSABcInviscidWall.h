/**
 * \brief
 * Class Strand2dFCSPTurbSABcInviscidWall holds the data and specifies the
 * operations for
...
#ifndef included_Strand2dFCSPTurbSABcInviscidWall
#define included_Strand2dFCSPTurbSABcInviscidWall

#include "STRAND2DFC_defs.h"
#include "Strand2dFCSPTurbSABc.h"


class Strand2dFCSPTurbSABcInviscidWall: public Strand2dFCSPTurbSABc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Strand2dFCSPTurbSABcInviscidWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPTurbSA/Strand2dFCSPTurbSABcInviscidWall.C Strand2dFCSPTurbSABcInviscidWall
   */
  Strand2dFCSPTurbSABcInviscidWall();

  /**
   * \brief
   * Destructor for the Strand2dFCSPTurbSABcInviscidWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * 2014-6-2
   * \par Further Documentation:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABcInviscidWall.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABcInviscidWall.C surfaceForces
   */
