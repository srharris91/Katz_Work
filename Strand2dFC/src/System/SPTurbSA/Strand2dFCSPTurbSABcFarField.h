/**
 * \brief
 * Class Strand2dFCSPTurbSABcFarField holds the data and specifies the operations for
...
#ifndef included_Strand2dFCSPTurbSABcFarField
#define included_Strand2dFCSPTurbSABcFarField

#include "STRAND2DFC_defs.h"
#include "Strand2dFCSPTurbSABc.h"


class Strand2dFCSPTurbSABcFarField: public Strand2dFCSPTurbSABc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Strand2dFCSPTurbSABcFarField class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPTurbSA/Strand2dFCSPTurbSABcFarField.C Strand2dFCSPTurbSABcFarField
   */
  Strand2dFCSPTurbSABcFarField();

  /**
   * \brief
   * Destructor for the Strand2dFCSPTurbSABcFarField class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * 2014-6-2
   * \par Further Documentation:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABcFarField.C
   */
