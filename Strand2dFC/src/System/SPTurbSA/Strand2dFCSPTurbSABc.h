/**
 * \brief
 * Class Strand2dFCSPTurbSABc holds the data and specifies the operations for
...
#ifndef included_Strand2dFCSPTurbSABc
#define included_Strand2dFCSPTurbSABc
...
class Strand2dFCSPTurbSABc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the Strand2dFCSPTurbSABc class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C Strand2dFCSPTurbSABc
   */
  Strand2dFCSPTurbSABc();

  /**
   * \brief
   * Destructor for the Strand2dFCSPTurbSABc class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C ~Strand2dFCSPTurbSABc
   */
  virtual ~Strand2dFCSPTurbSABc();

  /**
   * \brief
   * Initialize the Strand2dFCSPTurbSABc class and derived classes.
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C initialize
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C BCVector
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C BCVectorSelfJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C BCSelectionMatrix
   */
   ...
   * 2014-6-2
   * \par Further Documentation:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C BCPenaltyJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C penaltyData
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C surfaceForces
   */
  ...
  /**
   * \brief
   * Release memory for the Strand2dFCSPTurbSABc class and derived classes.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/Strand2dFCSPTurbSABc.C finalize
   */
  void finalize();
