...
class Strand2dFCBlockSolver
{
 public:
  ...
  /**
   * \brief
   * Computes LHS Jacobian terms for dissipation terms.
   * \param j Index of current layer in strand grid.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   */
  void lhsDissipation(const int& j);

  /**
   * \brief
   * Computes LHS Jacobian terms for inviscid terms.
   * \param j Index of current layer in strand grid.
   * \author
   * Aaron Katz
   * \version
 ...
 private:
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/Numerics/sourceStencil.C
   */
  void sourceStencil();
  ...
  /**
   * \brief
   * Define 1d finite difference coefficients (inviscid terms).
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/Numerics/fdCoeffInviscid.C
   */
  void fdCoeffInviscid();

  /**
   * \brief
   * Define 1d finite difference coefficients (dissipation terms).
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/Numerics/fdCoeffDissipation.C
   */
  void fdCoeffDissipation();

  /**
   * \brief
   * Define 1d finite difference coefficients (viscous terms).
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/Numerics/fdCoeffViscous.C
   */
  void fdCoeffViscous();
  ...
  /**
   * \brief
   * Setup source term weight coefficients.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/Numerics/sourceSetup.C
   */
  void sourceSetup();
   ...
   */
  void rhsDissipation(const int& j);
   ...
   */
  void rhsViscous(const int& j);

  /**
   * \brief
   * Adds viscous terms LHS Jacobian.
   * \param j Index of current layer in strand grid.
   * \author
   * Aaron Katz
   * \version
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/Numerics/lhsViscous.C
   */
  void lhsViscous(const int& j);
   ...
   */
  void rhsSource(const int& j);

  /**
   * \brief
   * Adds physical source term Jacobian to the LHS.
   * \param j Index of current layer in strand grid.
   * \author
   * Aaron Katz
   * \version
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/Numerics/lhsSource.C
   */
  void lhsSource(const int& j);
  ...
  /**
   * \brief
   * Add multigrid source terms to the RHS residual.
   * \param j Index of current layer in strand grid.
  ...
  Array4D<double> qx;
  Array3D<double> lim;
  Array3D<double> surfData;
  Array4D<double> surfDataVis;
  Array3D<double> bndData;
  Array4D<double> bndDataVis;
  Array4D<double> Ads;
  Array3D<double> Adl;
  Array4D<double> qas;
};
