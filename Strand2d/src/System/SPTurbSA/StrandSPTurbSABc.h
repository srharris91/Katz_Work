/**
 * \brief
 * Class SPTurbSA holds the data and specifies the operations for
...
#ifndef included_StrandSPTurbSABc
#define included_StrandSPTurbSABc
...
class StrandSPTurbSABc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the SPTurbSA class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABc.C StrandSPTurbSABc
   */
  StrandSPTurbSABc();

  /**
   * \brief
   * Destructor for the SPTurbSA class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
  ...
  /**
   * \brief
   * Initialize the SPTurbSA class and derived classes.
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABc.C initialize
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABc.C BCVector
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABc.C BCVectorSelfJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABc.C BCVectorInteriorJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABc.C surfaceForces
   */
  ...
  /**
   * \brief
   * Release memory for the SPTurbSA class and derived classes.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABc.C finalize
   */
  void finalize();
