...
!! \par Source code:
!! \include src/System/StrandSPTurbSA/StrandSPTurbSAStepHeader.F90


SUBROUTINE strandspturbsastepheader( &
     step)
...
WRITE(iu,'(A)')'<PPointData Scalars="P T rho entropy muT" Vectors="U">'
...
WRITE(iu,'(A)')'<PDataArray type="Float32" Name="muT"/>'
...
WRITE(iu,'(A)')'<VTKFile type="PUnstructuredGrid" version="0.1" byte_order="LittleEndian">'
WRITE(iu,'(A)')'<PUnstructuredGrid GhostLevel="0">'
WRITE(iu,'(A)')'<PCellData Scalars="r1 r2 r3 r4 r5">'
...
WRITE(iu,'(A)')'<PDataArray type="Float32" Name="r5"/>'
...
WRITE(iu,'(A)')'<PDataArray type="Float32" Name="e5"/>'
WRITE(iu,'(A)')'</PCellData>'
WRITE(iu,'(A)')'<PPoints>'
WRITE(iu,'(A)')'<PDataArray type="Float32" NumberOfComponents="3"/>'
WRITE(iu,'(A)')'</PPoints>'
...
END SUBROUTINE strandspturbsastepheader
