...
#ifndef included_StrandSPTurbSA
#define included_StrandSPTurbSA
...
#include "StrandSPTurbSABcFarField.h"
#include "StrandSPTurbSABcDirichlet.h"
#include "StrandSPTurbSABcFrozen.h"


class StrandSPTurbSA: public StrandSystem
{
 public:

  /**
   * \brief
   * Constructor for the StrandSPTurbSA class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet src/System/SPTurbSA/StrandSPTurbSA.C StrandSPTurbSA
   */
  StrandSPTurbSA();

  /**
   * \brief
   * Destructor for the StrandSPTurbSA class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/stepSourceEigenvalue.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/rhsInvFlux.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/rhsDisFluxCoarse.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/rhsVisFluxCoarse.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code
   * \include src/System/SPTurbSA/rhsSource.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code
   * \include src/System/SPTurbSA/rhsSourceCoarse.C
   */
  void rhsSourceCoarse(const int& npts,
		       const double* v,
		       const double* q,
		       const double* qa,
		       double* r);
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/lhsVisFluxJacobian.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/lhsSourceJacobian.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/lhsSourceJacobianCoarse.C
   */
  void lhsSourceJacobianCoarse(const int& npts,
			       const double* v,
			       const double* q,
			       const double* qa,
			       double* M);
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/lhsBCVectorInteriorJacobian.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/lhsPrimVarJacobian.C
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \include src/System/SPTurbSA/outputInitialize.C
   */
