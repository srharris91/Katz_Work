/**
 * \brief
 * Class StrandSPLamBcInviscidWall holds the data and specifies the
 * operations for
...
#ifndef included_StrandSPLamBcInviscidWall
#define included_StrandSPLamBcInviscidWall

#include "STRAND_defs.h"
#include "StrandSPLamBc.h"


class StrandSPLamBcInviscidWall: public StrandSPLamBc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the StrandSPLamBcInviscidWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPLam/StrandSPLamBcInviscidWall.C StrandSPLamBcInviscidWall
   */
  StrandSPLamBcInviscidWall();

  /**
   * \brief
   * Destructor for the StrandSPLamBcInviscidWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPLam/StrandSPLamBcInviscidWall.C BCVector
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/StrandSPLamBcInviscidWall.C BCVectorSelfJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/StrandSPLamBcInviscidWall.C BCVectorInteriorJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPLam/StrandSPLamBcInviscidWall.C surfaceForces
   */
