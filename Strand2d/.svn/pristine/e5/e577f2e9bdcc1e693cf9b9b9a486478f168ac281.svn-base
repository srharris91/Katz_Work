/**
 * \brief
 * Class StrandSPTurbSABcInflow holds the data and specifies the operations for
...
#ifndef included_StrandSPTurbSABcInflow
#define included_StrandSPTurbSABcInflow

#include "STRAND_defs.h"
#include "StrandSPTurbSABc.h"


class StrandSPTurbSABcInflow: public StrandSPTurbSABc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the StrandSPTurbSABcInflow class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPTurbSA/StrandSPTurbSABcInflow.C StrandSPTurbSABcInflow
   */
  StrandSPTurbSABcInflow();

  /**
   * \brief
   * Destructor for the StrandSPTurbSABcInflow class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABcInflow.C BCVectorSelfJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABcInflow.C BCVectorInteriorJacobian
   */
