/**
 * \brief
 * Class StrandSPTurbSABcViscousWall holds the data and specifies the operations for
...
#ifndef included_StrandSPTurbSABcViscousWall
#define included_StrandSPTurbSABcViscousWall

#include "STRAND_defs.h"
#include "StrandSPTurbSABc.h"


class StrandSPTurbSABcViscousWall: public StrandSPTurbSABc
{
 ...
 public:
  ...
  /**
   * \brief
   * Constructor for the StrandSPTurbSABcViscousWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPTurbSA/StrandSPTurbSABcViscousWall.C StrandSPTurbSABcViscousWall
   */
  StrandSPTurbSABcViscousWall();

  /**
   * \brief
   * Destructor for the StrandSPTurbSABcViscousWall class.
   * \author
   * Aaron Katz
   * \version
   * 1.0
   ...
   * \par Source Code:
   * \snippet
   * src/System/SystemSPTurbSA/StrandSPTurbSABcViscousWall.C BCVector
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABcViscousWall.C BCVectorSelfJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABcViscousWall.C BCVectorInteriorJacobian
   */
   ...
   * \par Further Documentation:
   * \par Source Code:
   * \snippet src/System/SystemSPTurbSA/StrandSPTurbSABcViscousWall.C surfaceForces
   */
